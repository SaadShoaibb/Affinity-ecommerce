                    ...
                    {isFreeItem ? (
                        ...
                        <>
                            <select
                                ...
                                className='border rounded-md px-2 py-1 text-sm bg-white cursor-pointer text-black'
                            >
                ...
                <div className='flex flex-col h-full'>
                    ...
                    <div className='flex items-center justify-between p-4 border-b bg-gray-50'>
                        <div className='flex items-center gap-2'>
                            ...
                            <span className='bg-gray-200 px-2 py-1 rounded-full text-sm text-black font-medium'>
                                {getTotalItems()}
                            </span>
                        </div>
                        <button
                        ...
                        <div className='border-t'>
                            ...
                            <div className='p-4 space-y-4'>
                                ...
                                <div className='border-t pt-4'>
                                    ...
                                    <button
                                        className='w-full bg-purple-700 text-white py-4 rounded-full font-bold hover:bg-purple-500 transition-colors flex items-center justify-center'
